  ...
  return (
    <div className="mt-3 flex w-[80%] flex-col items-center justify-center gap-1 border-t-2 border-gray-300">
      ...
      <div className="item-center flex justify-center gap-2">
        <button
          type="button"
          className="h-10 w-10 rounded-sm border-[1px] border-gray-500 p-2 opacity-80 hover:border-2 hover:border-gray-800 hover:opacity-100 focus:opacity-100 focus:outline-2 focus:outline-gray-800"
        >
          <img
